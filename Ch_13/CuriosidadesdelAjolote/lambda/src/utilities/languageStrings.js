...
module.exports = {
  es: {
    translation: {
      ...
      WELCOME_MSG: '<emphasis level="strong">¡Hola {{name}}!</emphasis>  bienvenido a Curiosidades del Ajolote, para comenzar puedes decir: dime un dato curioso del ajolote... o si deseas detenerme solo di: ¡Cancela!... entonces, ¿cómo te puedo ayudar?',
      HELLO_MSG_WITHOUT_SSML: '¡Hola {{name}}!  bienvenido a Curiosidades del Ajolote, para comenzar puedes decir: dime un dato curioso del ajolote... o si deseas detenerme solo di: ¡Cancela!... entonces, ¿cómo te puedo ayudar?',
